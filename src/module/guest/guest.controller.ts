...
export class GuestController {
  ...
  @ApiResponse({ status: 200, description: 'Instructions sent (if the account exists).', type: ForgotPasswordResponseDto })
  ...
  @ApiOperation({
    ...
    description: 'Sets a new password using the token from the reset password link, passed as a header.',
  })
  @ApiHeader({
    name: 'x-reset-token',
